...
_KEYS = [
    ...
    'android presentation.device 1', 'android presentation.device 2', 'android presentation.device 3',
    'android presentation.device 4', 'android presentation.device 5', 'android presentation.device 6',
    'android presentation.device 7', 'android presentation.device 8',
]
