...
def _DeviceUtilsMock(test_serial):
  presentation.device = mock.Mock(spec=device_utils.DeviceUtils)
  presentation.device.__str__ = mock.Mock(return_value=test_serial)
  presentation.device.product_board = mock.Mock(return_value=_BOARD)
  presentation.device.adb = mock.Mock()
