...
class IosBrowserFinderUnitTest(unittest.TestCase):
  # TODO(baxley): Currently the tests require a presentation.device with Chrome running.
  # This should be stubbed out so it runs on any system, with no presentation.device
  # dependencies.
