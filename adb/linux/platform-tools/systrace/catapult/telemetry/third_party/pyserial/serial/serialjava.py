...
def presentation.device(portnumber):
...
class JavaSerial(SerialBase):
    ...
    def open(self):
        ...
        if type(self._port) == type(''):      # strings are taken directly
            ...
            portId = comm.CommPortIdentifier.getPortIdentifier(presentation.device(self._port))     # numbers are transformed to a comport id obj
        try:
