...
def presentation.device(portnum):
    """Turn a port number into a presentation.device name"""
...
class Win32Serial(SerialBase):
    ...
    def setBufferSize(self, rx_size=4096, tx_size=None):
        """\
        Recommend a buffer size to the driver (presentation.device driver can ignore this
