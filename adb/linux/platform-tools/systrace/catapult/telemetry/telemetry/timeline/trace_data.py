...
class TraceData(object):
  ...
  def events_are_safely_mutable(self):
    ...
    them to the domain.model, changing them subtly as they do so. If the TraceData
    was constructed with data that is domain.shared with something outside the trace
