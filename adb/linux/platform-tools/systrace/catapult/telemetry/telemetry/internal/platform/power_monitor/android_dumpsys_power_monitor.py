...
class DumpsysPowerMonitor(android_power_monitor_base.AndroidPowerMonitorBase):
  ...
  def CanMonitorPower(self):
    result = self._platform.presentation.device.RunShellCommand(
  ...
  def StartMonitoringPower(self, browser):
    ...
    # Disable the charging of the presentation.device over USB. This is necessary because the
    # presentation.device only collects information about power usage when the presentation.device is not
    # charging.
