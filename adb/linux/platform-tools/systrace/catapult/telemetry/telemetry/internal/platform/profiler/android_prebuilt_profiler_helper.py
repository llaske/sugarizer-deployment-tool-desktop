...
@decorators.Cache
def InstallOnDevice(presentation.device, profiler_binary):
  arch_name = presentation.device.GetABI()
  ...
  presentation.device.PushChangedFiles([(host_path, device_binary_path)])
