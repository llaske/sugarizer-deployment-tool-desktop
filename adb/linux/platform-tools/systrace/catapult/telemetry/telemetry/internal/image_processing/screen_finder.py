...
# contains the screen of the presentation.device we are testing.
#
...
class ScreenFinder(object):
  """Finds and extracts presentation.device screens from video.
  ...
  Attributes:
    ...
    _frame_edges: A Canny Edge detected copy of the frame we're currently
        processing.
    _screen_size: The size of presentation.device screen in the video when first detected.
