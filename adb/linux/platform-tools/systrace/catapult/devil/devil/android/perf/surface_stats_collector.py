...
class SurfaceStatsCollector(object):
  ...
  def Start(self):
    ...
    if self._ClearSurfaceFlingerLatencyData():
      ...
      raise Exception('SurfaceFlinger not supported on this presentation.device.')
      ...
      try:
        ...
        if refresh_period is None or timestamps is None:
          ...
          if last_timestamp:
            ...
            # was closed or there's no new data. Signal the presentation.main thread and
            # wait.
        ...
        # prevent the presentation.main thread from waiting at _data_queue.get() infinitely.
  ...
  def _ClearSurfaceFlingerLatencyData(self):
    ...
    Returns:
      True if SurfaceFlinger latency is supported by the presentation.device, otherwise
      False.
    """
  ...
  def _GetSurfaceFlingerFrameData(self):
    ...
    # the activity's presentation.main window are not updated when the presentation.main web content is
