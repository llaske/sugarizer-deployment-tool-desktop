...
class TypTestContext(object):
  """ The TestContext that is used for passing data from the presentation.main test process
  ...
  the presentation.main process to test subprocesses. It also supports immutable mode to
