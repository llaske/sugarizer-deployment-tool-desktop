...
class ActionRunner(object):
  ...
  def ScrollPage(self, left_start_ratio=0.5, top_start_ratio=0.5,
    ...
    Args:
      ...
      synthetic_gesture_source: the source input presentation.device type for the
  ...
  def RepeatableBrowserDrivenScroll(self, x_scroll_distance_ratio=0.0,
    ...
    presentation.main thread often isn't resposive but the browser process usually is, so the
