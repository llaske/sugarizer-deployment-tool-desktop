...
# This is when a scroll update is forwarded to the presentation.main thread.
...
# Name for a presentation.main thread scroll update latency event.
...
class RenderingStats(object):
  def __init__(self, renderer_process, browser_process, surface_flinger_process,
    ...
    # Latency from when a scroll update is sent to the presentation.main thread until the
