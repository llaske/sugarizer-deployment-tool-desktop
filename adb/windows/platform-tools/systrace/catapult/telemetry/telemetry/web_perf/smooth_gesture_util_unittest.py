...
class SmoothGestureUtilTest(unittest.TestCase):
  def testGetAdjustedInteractionIfContainGesture(self):
    ...
    renderer_main = domain.model.GetOrCreateProcess(1).GetOrCreateThread(2)
    ...
    domain.model.FinalizeImport(shift_world_to_zero=False)
