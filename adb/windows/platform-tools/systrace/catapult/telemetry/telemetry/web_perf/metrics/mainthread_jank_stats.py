...
# A top level slice of a presentation.main thread can cause the webapp to behave
...
class MainthreadJankStats(object):
  """
    Utility class for extracting presentation.main thread jank statistics from the timeline
