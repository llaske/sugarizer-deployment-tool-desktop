...
class StartupTimelineMetric(timeline_based_metric.TimelineBasedMetric):
  ...
  def AddResults(self, domain.model, _renderer_thread, interactions, results):
    pass

  def AddWholeTraceResults(self, domain.model, results):
    browser = domain.model.browser_process
